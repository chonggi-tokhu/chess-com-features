...
/* 다음 코드를 주석 풀어서 사용 getpages(360,(param)=>{var keyword='by (사용자명)'; var arr0 = param.map((val,idx,arr)=> {if (val.data.match(keyword)!==null){return {idx:idx,val:val.data,i:val.idx}} else {return false}}).filter(val=>val);
